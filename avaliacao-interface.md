...
- Os menus em configuração (ícone de engrenagem) e menu do usuário estão com os mesmos itens. Remova esse de configuração e mantenha somente o do usuário (dropdown-usuario.png)
