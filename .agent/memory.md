...
| 4 — Conector e preview | TASK-37..46 | 🔄 (37–42, 44 ✅) | PreviewConfig schema, preview-kit, connector CLI (discovery/entrypoints/build via Vite), component_previews, upload endpoint autenticado, tokens, exemplo CI, rota de artefatos estáticos |
...
1. **Fase 3 concluída (TASK-30 a 36)**: modelo de blocks, autosave, publish/snapshot e histórico/restauração de revisões todos prontos. Fase 4 em andamento na branch `feature/fase-4-conector-preview` — TASK-37 a 42 e 44 feitas; próxima é a TASK-43 (endpoint POST /api/previews usando findActiveUploadToken) e depois TASK-45/46.
